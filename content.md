{{titlepage,dark
# The Actisen Manual of Mountain Monsters
...
\page
##### Babling
A small black haired person made out of molten magma that can’t carry weapons.
...
##### Bay Creeper
A 80 tentacled squid like creature with tentacles on its head and 18 eyes. Typically found in bays and other sheltered sea water regions.
...
**AC** 12 **HP** 2 **ATK** 1 Bite (1d4) **MV** Close **S** +1 **D** -1 **C** +1 **I** -2 **W** -1 **Ch** +2 **AL** N **LV** 1
Rollilitch
An undead rollypolly who has mastered the forbidden and ancient art of lichdom. It also happens to be the size of a bus.
...
**AC** 18 **HP** 31 **ATK** 1 Claw +3 (1d8+2, Limb Removal) **MV** Close **S** +4 **D** -1 **C** +1 **I** +1 **W** -1 **Ch** +0 **AL** C **LV** 6

**Camouflage.** Earth Crab is extremely hard to see if it’s not moving. DC 15 Wisdom to spot or it gains ADV on its first attack.

**Limb Removal.** DC 10 Constitution or a limb is lost.
...
##### Fungus Cube
200 feet per side and able to smash buildings. Deep within the semi-translucent fungal mass an enormous brain can be seen.

**AC** 11 **HP** 1000 **ATK** 1 Engulf +0 (1d10/turn, DC 12 STR to escape) **MV** ½ Near **S** +1 **D** -3 **C** -1 **I** +3 **W** +1 **Ch** -2 **AL** C **LV** 10

##### Giant Centipede
Take from book

##### Grass Chomper
A 3” long grasshopper with sharp teeth capable of chewing through flesh and rooty vegetation. Will aggressively swarm undead.

**AC** 19* **HP** 4 **ATK** 1 Bite -1 (1d4) **MV** Near (ground) Close (fly) **S** -1 **D** +4 **C** +0 **I** -3 **W** -2 **Ch** -3 **AL** L **LV** 1

**Swarming.** When swarming in groups of 5+ their AC drops to 14. When attacking make 1 attack role for the group and any damage rolls forward. Bite now attacks with +2 (1d10).
- 5+ swarm: 2 bite +2 (1d4)
- 10+ swarm: 3 bite +3 (1d4)
- 15+ swarm: 4 bite +4 (1d4)
- 20+ swarm: 5 bite +5 (1d4)

\page

##### Ice Elemental
A solid block of ice shattered and reformed in the shape of a humanoid.
...
##### Metal Termite
An insect that resembles an ant with a small needle between its mandibles and a pointed abdomen. They live in colonies of up to a thousand. Like to dig their tunnels in rusted metal. 

**AC** 15 **HP** 35 **ATK** 5 Bite +0 (1d4) **MV** Near (ground, fly) **S** -3 **D** +2 **C** +1 **I** -1 **W** +0 **Ch** +1 **AL** N

##### Mig Fig
Boss MONSTER
A giant worm that’s twice the size of a small island, fangs the size of a skyscraper.

**AC** 12 **HP** 400 **ATK** 1 Bone Crunch +0 (1d20, Consume) **MV** Far **S** +6 **D** -3 **C** +1 **I** +2 **W** +1 **Ch** +0 **AL** C **LV** 100

###### Mig Fig Weak Spot x10
...
##### Mountain Brute
*Humanoid figure of an angler fish that lurks underground in caves and tunnels they create below rivers.*

**AC** 17 **HP** 45 **ATK** 1 Bite +0 (1d6) and 2 Grab +0 (0, Tackle) **S** +2 **D** +1 **C** +1 **I** -2 **W** -3 **Ch** +1 **AL** L **LV** 6

**Tackle.** If 1 grab hits +1 (3d6); if 2 grabs hit (auto hit) (3d6)

##### Mountain Worm
A small footlong worm with 4 teeth that are prone to breaking and getting lodged in it’s victims.
...
##### Riverling
A water elemental cloaked in clothing and has shaped its face into a skull. It’s robes are its hands.
...
**AC** 19 **HP** 40 **ATK** 1 Boulder Smash (Double Near) +5 (1d10) or 2 Punch +0 (1d6, DC 15 Str or Stuck) **S** +2 **D** +0 **C** +0 **I** +1 **W** +1 **Ch** +1 **LV** 9

**Boulder Smash.** Grabs a nearby boulder and throws it at target

**Stuck.** Immobilized as you are stuck after being punch into the ground. DC 15 Str to pull yourself 
...
##### Snowel
Living snowman with four arms and legs made out of snow. Wears a pumpkin as a hat.
